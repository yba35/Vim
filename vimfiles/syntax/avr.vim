...
syn keyword avrBranch   rjmp ijmp eijmp jmp rcall eicall call ret reti
" conditional branches, by status flags
syn keyword avrBranch   brbs brbc 
syn keyword avrBranch   brcc brcs brvs brvc brmi brpl breq brne brhs brhc
syn keyword avrBranch   brts brtc brie brid
" conditional branches, by arithmetic expression
syn keyword avrBranch   brlo brlt brge brsh
" conditional skip
syn keyword avrBranch   cpse sbrc sbrs sbic sbis
...
" special registers
syn keyword avrRegSpec  X Y Z XH XL YH YL ZH ZL
